...
empty_List = []
empty_List.append('Emir')
print(empty_List)

empty_List.append('Python')
print(empty_List)

empty_List.append('Guido van Rossum')
print(empty_List)

del empty_List[0]
print(empty_List)

empty_List.append("is the inventor of")
print(empty_List)

empty_List.append(empty_List.pop(0))
print(empty_List)
...
for x in range(5):
    ...
    if user_number < 3 or user_number > 7:
        ...
        break
    if user_number < 5:
        passwordList = random.choices(words, k=user_number)
        password = ''.join(passwordList)
        passwordList1.add(password)

    if user_number >= 5:
        passwordList = random.choices(words, k=user_number)
        password = ''.join(passwordList)
        passwordList2.add(password)

print(' ')
print(passwordList2.union(passwordList1))

print(' ')
# task 3

dict1 = {1: 1, 2: 4, 3: 9, 4: 16, 5: 25, 6: 36, 7: 49, 8: 64, 9: 81, 10: 100, 11: 121, 12: 144, 13: 169, 14: 196, 15: 225, 16: 256, 17: 289, 18: 324, 19: 361, 20: 400, 21: 441, 22: 484, 23: 529, 24: 576, 25: 625, 26: 676, 27: 729, 28: 784, 29: 841, 30: 900}
...
print(' ')
print("Max value is: ", max(merged_dictionary.values()))
print("Max value is: ", min(merged_dictionary.values()))
